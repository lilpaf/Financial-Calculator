...
{
    class FVIntrestRateMoreThanOnceAYear : FVInterestOnceAYear
    {
        //private decimal presentValue;
        //private double interestRate;
        private int years;
        private int numberOfCompoundingPeriods; //per year
        ...
        {
            return base.presentValue * (decimal)Math.Pow(1 + ((base.interestRate / 100) / numberOfCompoundingPeriods), numberOfCompoundingPeriods * years);
        }
    }
}
